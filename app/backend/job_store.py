...
def create_job(req: JobCreateRequest, voice_data: dict | None = None) -> dict:
    ...
    job = {
        ...
        "voice_style": req.voice_style or "professional_natural",
        "voice_pace": req.voice_pace or "natural",
        "voice_quality": req.voice_quality or "high",
        "voice_seed": req.voice_seed,
        "voice_best_of": req.voice_best_of,
        "voice_cfg": req.voice_cfg,
        "voice_inference_timesteps": req.voice_inference_timesteps,
        "voice_text_normalize": req.voice_text_normalize,
        "voice_reference_cleanup": req.voice_reference_cleanup,
        "voice_retry_badcase": req.voice_retry_badcase,
