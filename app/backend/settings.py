...
OUTROS_JSON = Path(
    os.getenv("DHJR_OUTROS_JSON", str(AI_WORKSPACE / "app/config/outros.json"))
).expanduser()
OUTRO_ASSETS_DIR = Path(
    os.getenv("DHJR_OUTRO_ASSETS_DIR", str(AI_WORKSPACE / "assets/outros"))
).expanduser()
...
MAX_OUTRO_DURATION_SECONDS = float(os.getenv("DHJR_MAX_OUTRO_DURATION_SECONDS", "60"))
